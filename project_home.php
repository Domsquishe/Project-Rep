...
<div class="container box">
  ...
  <body>
    ...
    <p>Please enter the addresses you would like to use</p> <br>

    <div class="formDiv">
      <form id="addressform" name="addressform" method="post" action="project_display.php">
        <table>
          <tr>
            <td> &nbsp 1st address :&nbsp </td>
            <td><input type="text" id="address1" name="address1"></td> <br>
            <td> &nbsp 2nd address :&nbsp </td>
